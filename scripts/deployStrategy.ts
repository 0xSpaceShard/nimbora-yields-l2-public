...
async function deploy_strategy() {
    ...
    const min_deposit = "10000000000000000";
    // min deposit 100 ETH
    const max_deposit = "100000000000000000000";
    // min withdrawal 0.01 ETH
    const min_withdrawal = "10000000000000000";
    // max withdrawal 100 ETH
    const max_withdrawal = "100000000000000000000";
    const withdrawal_epoch_delay = "3";
    // dust limit = 1% of l1 net asset value
    const dust_limit_factor = "10000000000000000";
